...
<div class="d-flex flex-column align-items-center border inner p-3">
	...
	<div class="box position-relative">
		...
		>
		<button class="btn reset px-3 py-1 border" disabled={!resetBtn} on:click={resetSnapshot}>Reset</button>
	</div>
</div>
